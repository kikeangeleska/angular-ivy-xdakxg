...
export class LcdDisplayComponent implements OnInit {
  ...
  showNumber() {
    ...
    // if (
    //   this.minNumberLength !== null &&
    //   this.maxNumberLength !== null &&
    //   this.minNumberLength !== undefined &&
    //   this.maxNumberLength !== undefined
    // )
    ...
    // if (
    //   this.minNumberLength &&
    //   this.displayValue.length < this.minNumberLength
    // ) {
    ...
    //   this.displayValue.length > this.maxNumberLength
    // ) {
    //   let output = '';
